...
export default function BrandFrame() {
 return <main id="content" className="recruitment brand-frame">
  ...
  <section className="bf-values-hero">
   ...
   <div className="bf-values-title"><p>WE'RE HIRING.</p><h1>DIGITAL · UI/UX<br/>DESIGNER</h1></div><p className="bf-hero-philosophy">상상은 자유롭게,<br/>결정은 전략적으로.</p>
  </section>
  <div className="bf-facts" aria-label="채용 조건"><span>경력 2년 이상</span><span>정규직</span><span>서울 마포</span></div>
  ...
  <section className="bf-block bf-people"><div className="bf-section-top"><span>03 / YOU & VW</span><span>지원 자격</span></div><h2>이런 당신을 기다립니다.</h2><div className="bf-qualification"><h3>함께하기 위한 경험</h3><ul><li>학력 무관<br/><span>실무 경력 2년 이상<br/><strong>포트폴리오 제출 필수</strong></span></li><li>웹·모바일 UI/UX 디자인 실무 경험</li><li>사용자 관점에서 문제를 파악하고,<br/>디자인 의도를 설명할 수 있는 분</li><li>타이포그래피·레이아웃 등 디테일과<br/>일관성을 중요하게 생각하는 분</li><li>PM·개발자와 의견을 나누며 협업할 수 있는 분</li></ul></div><div className="bf-qualification"><h3>더 반가운 경험 <small>우대사항</small></h3><ul><li>Figma 프로토타이핑·컴포넌트 활용 경험</li><li>브랜드·프로덕트 또는 에이전시 디자인 경험</li><li>모션·인터랙션으로 디자인 의도를 표현한 경험</li><li>생성형 AI 도구를 디자인 과정에 활용한 경험</li></ul></div></section>
  ...
  <section className="bf-block bf-terms"><div className="bf-section-top"><span>WORK & LIFE</span><span>근무 안내</span></div><dl><div><dt>고용형태</dt><dd>정규직 <small>· 수습 3개월</small></dd></div><div><dt>연봉</dt><dd>3,000~5,000만원<small>면접 후 결정</small></dd></div><div><dt>근무시간</dt><dd>09:30 — 18:30<small>주 5일 (월~금) · 탄력근무제</small></dd></div><div><dt>근무장소</dt><dd>서울 마포구 성산동<small>월드컵로32길 24, 중보빌딩 3층<br/>6호선 마포구청역 도보 4분 이내</small></dd></div><div className="bf-support"><dt>복리후생</dt><dd><strong>잘 일하고, 편히 쉴 수 있도록.</strong><div className="bf-benefits"><article><h3>휴가는 자유롭게</h3><p>개인 일정에 맞춰<br/>연차와 반차를 자유롭게 사용합니다.</p></article><article><h3>잠깐의 여유도 든든하게</h3><p>일하는 중간 즐길 수 있는<br/>음료와 간식을 제공합니다.</p></article><article><h3>중요한 날에는 함께</h3><p>기쁜 일에도, 어려운 일에도<br/>경조휴가와 경조금을 지원합니다.</p></article><article><h3>좋은 작업을 위한 장비 투자</h3><p>업무에 필요한 장비에는<br/>투자를 아끼지 않습니다.</p></article></div><span className="bf-support-details">고용보험 · 산재보험 · 건강보험<br/>퇴직연금 · 노동절 휴무</span></dd></div></dl></section>
  ...
  <section className="bf-application"><div className="bf-section-top"><span>06 / JOIN US</span><span>함께할 다음</span></div><h2>당신을<br/><em>만나고 싶습니다.</em></h2><p className="bf-apply-intro">당신의 작업과 생각을 보여주세요.</p><ol className="bf-process"><li><small>01</small>서류전형</li><li><small>02</small>면접</li><li><small>03</small>최종합격</li></ol><div className="bf-apply-row"><h3>보내주실 자료</h3><p>이력서 · 포트폴리오<br/>희망연봉은 이력서에 필수로 기재해주세요.</p></div><div className="bf-apply-row"><h3>지원 방법</h3><p>잡코리아 이력서 양식으로 즉시지원</p></div><p className="bf-note">면접 일정은 추후 개별 안내됩니다.<br/>지원서에 허위 사실이 발견될 경우<br/>채용이 취소될 수 있습니다.</p><footer className="bf-signature-photo"><img src={asset('vw-signature-dark-v2.png')} alt="브이더블유 회사명과 조명이 켜진 VW 사인"/></footer></section>
 </main>;
}
