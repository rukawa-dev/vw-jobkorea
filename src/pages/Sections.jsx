...
export function Section3() { return (<section className="studio"><img src="/imgs/vw-office.jpg" alt="브이더블유 사무실 입구" /><div className="studio-copy"><p className="eyebrow">LIFE AT VW</p><h2>몰입할 시간.<br />재충전할 여유.</h2><p>자유로운 휴가문화<br />연차 · 반차 · 경조휴가 · 노동절 휴무<br />음료와 간식 제공 · 퇴직연금</p></div></section>); }
...
<footer className="footer"><div><img src="/imgs/로고.svg" alt="VW" /><p>㈜브이더블유 · DIGITAL BRANDING DIRECTORS</p></div><a href="https://www.v-w.co.kr/" target="_blank" rel="noopener noreferrer">우리의 작업 보기 ↗</a></footer>
</section>); }
