...
export default function RecruitmentList() {
  ...
  return <main className="recruitment-list" id="content" tabIndex={-1}>
    <header className="list-masthead"><img src={import.meta.env.BASE_URL + 'imgs/로고.svg'} alt="VW"/><span>DIGITAL BRANDING DIRECTORS</span><span className="list-archive-label">RECRUITMENT ARCHIVE</span><a className="list-github" href="https://github.com/rukawa-dev/vw-jobkorea" target="_blank" rel="noopener noreferrer" aria-label="GitHub 저장소 열기 (새 창)">GitHub <span aria-hidden="true">↗</span></a></header>
    ...
    <footer className="list-footer"><span>© 2026 VW. ㈜브이더블유</span><span>실제 공고 등록일을 기준으로 정리합니다.</span><a href="https://www.v-w.co.kr/" target="_blank" rel="noopener noreferrer">우리의 작업 보기 ↗</a></footer>
  </main>;
}
