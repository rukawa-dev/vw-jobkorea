...
export default function RecruitmentList() {
  ...
  return <main className="recruitment-list" id="content" tabIndex={-1}>
    <header className="list-masthead"><img src={import.meta.env.BASE_URL + 'imgs/로고.svg'} alt="VW"/><span>DIGITAL BRANDING DIRECTORS</span><span>RECRUITMENT ARCHIVE</span></header>
